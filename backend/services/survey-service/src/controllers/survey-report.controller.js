...
exports.DailyTeamWiseSurveyProgressReport = createNotImplementedHandler(CONTROLLER, 'DailyTeamWiseSurveyProgressReport', '');
exports.DailyTeamWiseHourlySurveyProgressReport = createNotImplementedHandler(CONTROLLER, 'DailyTeamWiseHourlySurveyProgressReport', '');
exports.FinalVillageFirstSurveyReport = createNotImplementedHandler(CONTROLLER, 'FinalVillageFirstSurveyReport', '');
exports.FinalVillageFirstSurveySummeryReport = createNotImplementedHandler(CONTROLLER, 'FinalVillageFirstSurveySummeryReport', '');
exports.SurveyUnitWiseSurveyStatus = createNotImplementedHandler(CONTROLLER, 'SurveyUnitWiseSurveyStatus', '');
exports.SurveyUnitWiseSurveyAreaSummary = createNotImplementedHandler(CONTROLLER, 'SurveyUnitWiseSurveyAreaSummary', '');
exports.SurveyActualVarietywise = createNotImplementedHandler(CONTROLLER, 'SurveyActualVarietywise', '');
