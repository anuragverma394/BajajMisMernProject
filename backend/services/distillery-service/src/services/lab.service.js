const repository = require("../repositories/lab.repository.js");
const { validateRequest } = require("../validations/lab.validation.js");
...
function wrapHandler(name, fn) {
  return async (...args) => {
    try {
      ...
      logServiceError("lab.service", name, error);
      throw error;
    }
  };
}
