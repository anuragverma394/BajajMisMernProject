...
exports.SugarBagProducedAdd = createNotImplementedHandler(CONTROLLER, 'SugarBagProducedAdd', '');
exports.SugarBagProducedAdd_2 = createNotImplementedHandler(CONTROLLER, 'SugarBagProducedAdd', 'SugarBagProducedView Model,string command');
exports.ShiftSet = createNotImplementedHandler(CONTROLLER, 'ShiftSet', 'string TIME');
exports.TestAnurag1 = createNotImplementedHandler(CONTROLLER, 'TestAnurag1', 'string pol,string brix');
exports.TestRohit1 = exports.TestAnurag1;
exports.DailyLabAnalysisAddDelete = createNotImplementedHandler(CONTROLLER, 'DailyLabAnalysisAddDelete', 'string TIME, string DDATE, string FACTORY, string MILL_NO');
exports.SugarBagProducedDelete = createNotImplementedHandler(CONTROLLER, 'SugarBagProducedDelete', 'string TIME, string H_DATE_PRIMARY, string FACTORY, string MILL_NO');
exports.SugarBagProducedAddID = createNotImplementedHandler(CONTROLLER, 'SugarBagProducedAddID', 'string TIME,string H_DATE ,string FACTORY,string MILL_NO');
...
exports.DailyLabAnalysisAdd = createNotImplementedHandler(CONTROLLER, 'DailyLabAnalysisAdd', '');
exports.DailyLabAnalysisAdd_2 = createNotImplementedHandler(CONTROLLER, 'DailyLabAnalysisAdd', 'DailyLabAnalysisEntry Model,string command');
exports.AMassecuiteView = createMassecuiteViewHandler({ tableName: 'LAB_A_MASS' });
exports.AMassecuite = createNotImplementedHandler(CONTROLLER, 'AMassecuite', '');
exports.AMassecuite_2 = createNotImplementedHandler(CONTROLLER, 'AMassecuite', 'AMassecuiteView Model, string Command');
exports.AMassecuiteDelete = createNotImplementedHandler(CONTROLLER, 'AMassecuiteDelete', 'string FACT, string DATE, string SLNO');
...
exports.A1Massecuite = createNotImplementedHandler(CONTROLLER, 'A1Massecuite', '');
exports.A1Massecuite_2 = createNotImplementedHandler(CONTROLLER, 'A1Massecuite', 'A1MassecuiteView Model, string Command');
exports.A1MassecuiteDelete = createNotImplementedHandler(CONTROLLER, 'A1MassecuiteDelete', 'string FACTORY, string DDATE, string SLNO');
...
exports.BMassecuite = createNotImplementedHandler(CONTROLLER, 'BMassecuite', '');
exports.BMassecuite_2 = createNotImplementedHandler(CONTROLLER, 'BMassecuite', 'string id, int F_Name, string DDATE, string TIME, string STRIKE_NO, string ANAL_BX, string ANAL_POL, string ANAL_PY, string QTY, string NO, string LOCATION_CODE');
exports.BMassecuiteDelete = createNotImplementedHandler(CONTROLLER, 'BMassecuiteDelete', 'string FACT, string DATE, string SLNO, string DIVN');
...
exports.CMassecuite = createNotImplementedHandler(CONTROLLER, 'CMassecuite', '');
exports.CMassecuite_2 = createNotImplementedHandler(CONTROLLER, 'CMassecuite', 'string id, int F_Name, string DDATE, string TIME, string STRIKE_NO, string ANAL_BX, string ANAL_POL, string ANAL_PY, string QTY, string NO, string LOCATION_CODE');
exports.CMassecuiteDelete = createNotImplementedHandler(CONTROLLER, 'CMassecuiteDelete', 'string FACT, string DATE, string SLNO, string DIVN');
...
exports.C1Massecuite = createNotImplementedHandler(CONTROLLER, 'C1Massecuite', '');
exports.C1Massecuite_2 = createNotImplementedHandler(CONTROLLER, 'C1Massecuite', 'string id, int F_Name, string DDATE, string TIME, string STRIKE_NO, string ANAL_BX, string ANAL_POL, string ANAL_PY, string QTY, string NO, string LOCATION_CODE');
exports.C1MassecuiteDelete = createNotImplementedHandler(CONTROLLER, 'C1MassecuiteDelete', 'string FACT, string DATE, string SLNO, string DIVN');
...
exports.R1 = createNotImplementedHandler(CONTROLLER, 'R1', '');
exports.R1_2 = createNotImplementedHandler(CONTROLLER, 'R1', 'string id, int F_Name, string DDATE, string TIME, string STRIKE_NO, string ANAL_BX, string ANAL_POL, string ANAL_PY, string QTY, string No');
exports.R1Delete = createNotImplementedHandler(CONTROLLER, 'R1Delete', 'string FACT, string DATE, string SLNO');
...
exports.R2 = createNotImplementedHandler(CONTROLLER, 'R2', '');
exports.R2_2 = createNotImplementedHandler(CONTROLLER, 'R2', 'string id, int F_Name, string DDATE, string TIME, string STRIKE_NO, string ANAL_BX, string ANAL_POL, string ANAL_PY, string QTY, string No');
exports.R2Delete = createNotImplementedHandler(CONTROLLER, 'R2Delete', 'string FACT, string DATE, string SLNO');
...
exports.TaregetvsActualMIS = createNotImplementedHandler(CONTROLLER, 'TaregetvsActualMIS', '');
exports.TaregetvsActualMIS_2 = createNotImplementedHandler(CONTROLLER, 'TaregetvsActualMIS', 'string id');
exports.GetCanePlanDataA = createNotImplementedHandler(CONTROLLER, 'GetCanePlanDataA', 'string CP_Unit');
exports.CalToDate = createNotImplementedHandler(CONTROLLER, 'CalToDate', 'string f_code,string Date');
    ...
    const rows = await executeQuery(
      `SELECT
       ...
       WHERE (@factoryCode = 0 OR wb.WB_Factory = @factoryCode)
         AND (@isAdmin = 1 OR wb.WB_Factory IN (
           SELECT uf.FactID
           FROM MI_UserFact uf
           WHERE uf.UserID = @userId
         ))
       ORDER BY wb.WB_FromDate ASC, wb.WB_ID ASC`,
      { factoryCode, isAdmin: isAdmin ? 1 : 0, userId },
      season
    );
  ...
  try {
    ...
    const rows = await executeQuery(
      `SELECT TOP 1
       ...
       FROM MI_WeeklyBudget
       WHERE WB_ID = @WB_ID AND WB_Factory = @WB_Factory
         AND (@isAdmin = 1 OR WB_Factory IN (
           SELECT uf.FactID
           FROM MI_UserFact uf
           WHERE uf.UserID = @userId
         ))`,
      { WB_ID, WB_Factory, isAdmin: isAdmin ? 1 : 0, userId },
      season
    );
