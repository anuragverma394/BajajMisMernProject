...
import { FaFileExcel, FaSearch, FaArrowLeft, FaPrint } from 'react-icons/fa';
import '../../styles/Report.css';
import '../../styles/DriageDetail.css';

const Report_DriageDetail = () => {
    ...
    return (
        <div className="report-container animate-in fade-in duration-500">
            ...
            <div className="report-card">
                <div className="report-card-header">
                    <h3 className="report-card-title">Driage Details List</h3>
                </div>
                <div className="report-card-content">
...
export default Report_DriageDetail;
