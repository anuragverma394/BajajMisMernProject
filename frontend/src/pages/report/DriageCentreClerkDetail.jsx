...
import '../../styles/base.css';const Report_DriageCentreClerkDetail = () => {const navigate = useNavigate();const [units, setUnits] = useState([]);const [loading, setLoading] = useState(false);const [reportData, setReportData] = useState([]);const [filters, setFilters] = useState({ unit: 'All',
  ...
  return (
    <div className="p-[20px] bg-white min-h-[100vh] font-['Segoe UI', Tahoma, Geneva, Verdana, sans-serif]">
            ...
            <div className={headerStyle}>
                DRIAGE CENTRE AND CLERK SUMMARY
            </div>
