...
const DISTILLERY_BHeavyEthanolReport = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const data = await distilleryService.getBHeavyReport(params);
            setReportData(data);
            toast.success("B Heavy report synchronized");
        } catch (error) {
    ...
    const handlePrint = () => {
        ...
        winPrint.document.write(`
            <html>
                <head>
                    <title>B Heavy Ethanol Report</title>
                    <style>
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `B_Heavy_Ethanol_Report_${selectedFactory}.xls`;
        a.click();
                ...
                <div className="dist-card">
                    <header className="dist-card-header">
                        <h2 className="dist-card-title">
                            ...
                            B Heavy Ethanol Monthly Report
                        </h2>
                    ...
                    <div className="dist-filter-box">
                        <div className="dist-filter-grid">
                            ...
                            <div className="dist-action-buttons">
                                <button className="btn-dist-primary" onClick={handleSearch} disabled={isLoading}>
...
export default DISTILLERY_BHeavyEthanolReport;
