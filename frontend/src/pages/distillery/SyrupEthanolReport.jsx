...
const DISTILLERY_SyrupEthanolReport = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const data = await distilleryService.getSyrupReport(params);
            setReportData(data);
            toast.success("Syrup report synchronized");
        } catch (error) {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `Syrup_Ethanol_Report_${selectedFactory}.xls`;
        a.click();
        ...
        <div className="dist-report-root animate-in fade-in duration-500">
            ...
            <div className="dist-report-container">
                <div className="dist-card">
                    <header className="dist-card-header dist-card-header-syrup">
                        <h2 className="dist-card-title">
                            <i className="fas fa-prescription-bottle-medical"></i>
                            Syrup Ethanol Monthly Report
                        </h2>
                    ...
                    <div className="dist-filter-box">
                        <div className="dist-filter-grid">
                            ...
                            <div className="dist-action-buttons">
                                <button className="btn-dist-primary btn-dist-primary-syrup" onClick={handleSearch} disabled={isLoading}>
                    ...
                    {isLoading ? (
                        <div className="dist-loading" >
                            <div className="dist-spinner dist-spinner-syrup"></div>
...
export default DISTILLERY_SyrupEthanolReport;
